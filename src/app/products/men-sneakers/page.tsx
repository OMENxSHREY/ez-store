...
// Product type definition (same as in FeaturedProducts)
interface Product {
  id: string;
  name: string;
  slug: string;
...
// Sample product data (extended from FeaturedProducts)
const products: Product[] = [
  {
    id: "1",
    name: "New Balance Men's 530",
    slug: "New Balance Men's 530",
    price: 8999,
    images: {
      main: "/images/nb530-1.jpg",
  ...
  return (
    <div className="pt-32 pb-16">
      ...
      <div className="relative h-[300px] w-full overflow-hidden">
        <Image
          src="https://ext.same-assets.com/2099767344/3670211569.jpeg"
          alt="Men's Sneakers Collection"
          fill
          className="object-cover"
        />
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white">Sneakers</h1>
        </div>
      </div>
